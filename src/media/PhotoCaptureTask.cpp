...
namespace media {
    PhotoCaptureTask::PhotoCaptureTask(
        int camera_count,
        std::string target_dir,
        std::string prefix) : camera_count(camera_count), target_dir(target_dir), file_name_prefix(prefix),
                              is_capturing(true) {
    }
    ...
    bool PhotoCaptureTask::save_video_frame(std::string serial, QImage image) {
    }
} // media

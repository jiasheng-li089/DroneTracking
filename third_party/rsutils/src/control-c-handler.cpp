...
bool control_c_handler::was_pressed() const { return sigint_ev.is_set(); }

void control_c_handler::reset() { sigint_ev.clear(); }

void control_c_handler::wait() { sigint_ev.clear_and_wait(); }
